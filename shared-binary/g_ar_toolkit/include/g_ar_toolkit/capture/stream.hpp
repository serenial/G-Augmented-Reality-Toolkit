...
namespace g_ar_toolkit
{
    namespace capture
    {
        ...
        public:
            ...
            void start_stream();
            void stop_stream();
            bool capture_frame(cv::Mat &, std::chrono::milliseconds);
        ...
        private:
            ...
            std::mutex m_mtx, m_image_mtx;
            std::condition_variable m_notifier, m_image_notifier;
            states m_last_state;
            bool m_is_streaming;
            ...
            std::exception_ptr m_last_exception, m_image_exception;
